...
%verändert das es auf DinA5 passt aber ohne viel plan was das eigl. macht.
...
%Gitarrenakkorde
\usepackage{guitar}
\renewcommand\guitarPreAccord{\footnotesize\strut\Alegreya}
...
%for music symbols in lyrics
\usepackage[minimal]{leadsheets}
\useleadsheetslibraries{musicsymbols}

%for multiple collums
\usepackage{multicol}

%infoboxen
\usepackage{awesomebox}
%set all box colours to bw
\definecolor{abnote}{RGB}{0,0,0}
\definecolor{abcaution}{RGB}{0,0,0}
\definecolor{abwarning}{RGB}{0,0,0}
\definecolor{abimportant}{RGB}{0,0,0}
\definecolor{abvrulecolor}{RGB}{0,0,0}
...
\begin{document}
  \pagestyle{empty}
    ...
    %\include{lieder/Die-Gedanken-sind-frei} % Beispiel Gitarren Akkorden
    %\include{lieder/Die-Internationale} % Beispiel mit Noten

    % Einfügen aller Lieder aus der mit dem Pythonscript automatisch erstellten Liederliste.
    \input{liederliste}
